...
import { playAnimation, builds, symbolMap, setSymbolMap } from "./data/data"
...
function OverrideSymbol() {
    ...
    return (
        <div class={style.OverrideSymbol}>
                                ...
                                <For each={symbol_map.maps}>
                                    {(map, _index) => (
                                        <li>
                                            ...
                                            <IconButton classList={{ [style.buttion]: true }} icon={DeleteIcon} onClick={[deleteOverSymbol, [index(), _index()]]} />
                                        </li>
                                    )}
                                </For>
                                <div>
            ...
            <Show when={props.sub}>
                <For each={props.sub}>
                    {(element, index) => {
                        ...
                        return (
                            <Show when={element.shown && buildFrame && buildFrame.shown && buildFrameCell}>
                                <img
